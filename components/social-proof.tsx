  ...
  return (
    <section className="py-10 sm:py-14 bg-muted/20 border-y border-border/40">
      <div className="max-w-[1080px] mx-auto px-5 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-wrap justify-center items-center gap-x-10 sm:gap-x-14 lg:gap-x-16 gap-y-6 sm:gap-y-8">
          {organizations.map((org) => (
            ...
            >
              <Image
                ...
                width={160}
                height={64}
                className={`w-auto ${org.height} object-contain grayscale opacity-60 hover:opacity-90 hover:grayscale-0 transition-all duration-300`}
              />
            </div>
          ))}
        </div>
